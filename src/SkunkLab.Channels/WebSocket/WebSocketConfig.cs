...
namespace SkunkLab.Channels.WebSocket
{
    ...
    {
        public WebSocketConfig(int maxIncomingMessageSize = 0x400000, int receiveLoopBufferSize = 0x2000,
            int sendBufferSize = 0x2000, double closeTimeoutMilliseconds = 250.0)
        {
